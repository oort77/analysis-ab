...
revenue_vs_occupancy = (
    ...
    .encode(
        ...
        size="guests:O",
        tooltip=["name", "occupancy", "revenue", "guests", "adr", "rating", "sim_score"],
...
occupancy_distr = (
    ...
    .properties(
        width=600, height=300, title="Occupancy distribution, rating>4?"
    )
)
...
occ_vs_rev_by_reviews = alt.Chart(df2).mark_point().encode(
    alt.X('occupancy:Q', scale=alt.Scale(zero=False)),
    alt.Y('revenue:Q', scale=alt.Scale(zero=False)),
    size='rating:O',
...
revenue_all = (
    ...
    .properties(
        width=600, height=300, title="Revenue distribution, rating>4?"
    )
)
...
ratings_histo = (
    ...
    .properties(
        width=600, height=300, title="Ratings (> 4.4) distribution"
    )
)
...
revenue_vs_rating = (
    ...
    .properties(
        width=600, height=300, title="Median revenue vs Rating (> 4)"
    )
)
